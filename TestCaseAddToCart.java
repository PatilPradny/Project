...
public class TestCaseAddToCart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@id='spree_user_email'])[2]")).sendKeys("patilpradnya3012@gmail.com.com");
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).click();
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).sendKeys("Pradnya@12345");
		...
		driver.findElement(By.id("order_ship_address_attributes_firstname")).sendKeys("Pradnya",Keys.TAB);
		driver.findElement(By.id("order_ship_address_attributes_lastname")).sendKeys(Keys.CLEAR,"Patil",Keys.TAB);
		driver.findElement(By.id("order_ship_address_attributes_phone")).sendKeys("8767681855");
